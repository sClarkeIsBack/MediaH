...
def Get():
		...
		auth = 'http://mediahubiptv.ddns.net:4545/enigma2.php?username='+username+'&password='+password+'&type=get_vod_categories'
...
def showlinks():
    ...
    win = Window('shortlinks.xml',path,'Default',caption='Written by sClarke - Powered By tinyurl.com')
    win.doModal()
    del win
