...
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.MediaHubIPTV/resources/ivue','MediaHubIPTV.ini'))
...
def iVueInt():
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.MediaHubIPTV/resources/ivue','ivuesettings.xml'))
	...
	dp = xbmcgui.DialogProgress()
	dp.create("MediaHubIPTV","Copying DB",'', 'Please Wait')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("MediaHubIPTV","Installing iVue TV Guide...",'', 'Please Wait')
