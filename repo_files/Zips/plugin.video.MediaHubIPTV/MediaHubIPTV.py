...
import base64, time
import unicodedata
AddonID = 'plugin.video.MediaHubIPTV'
ADDON=xbmcaddon.Addon(id='plugin.video.MediaHubIPTV')
__icon__        = ADDON.getAddonInfo('icon')
__self__        = xbmcaddon.Addon(id='plugin.video.MediaHubIPTV')
...
ServerURL = "http://151.80.105.187:4545/get.php?username=%s&password=%s&type=m3u&output=hls"%(Username,Password)
...
def correctPVR():
	...
	flawiptv = xbmcaddon.Addon('plugin.video.MediaHubIPTV')
...
def speed():
	xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.MediaHubIPTV/speedtest.py")')
